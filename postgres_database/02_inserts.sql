...
INSERT INTO public.roles (nom_rol) VALUES
('Administrador'),
('Veterinario'),
('Usuario');

INSERT INTO public.personas (nom_per, ape_per, fec_nac_per, tip_doc_per, doc_per, dir_per, cel_per, cel2_per, email_per, cont_per,gen_per,fot_per) VALUES
...
INSERT INTO public.otorgar_roles (id_rol, id_per) VALUES
(1,1),
(2,1),
(3,1),
(1,2),
...
INSERT INTO public.categorias_veterinario (nom_cat)
VALUES 
('Generalista'),
...
INSERT INTO public.veterinarios (id_vet, especialidad, horarios)
VALUES
...
INSERT INTO public.otorgar_categoria_vet (id_cat,id_vet)
VALUES
(1,1),
(2,2),
(3,3),
...
('Bella', 'Gato', 'Gris', 'Persa', 'Hills Science Diet', '2017-07-30', 5.1, 'F', 4, 'Esterilizado', 'https://parcerosfelinos.com/wp-content/uploads/2020/06/parceros-6.jpg'),
...
('Lola', 'Gato', 'Blanco', 'Angora Turco', 'Hills Science Diet', '2021-01-15', 4.5, 'F', 9, 'Esterilizado', ''),
...
('Bella', 'Gato', 'Blanco', 'Persa', 'Hills Science Diet', '2020-11-09', 5.5, 'F', 9, 'Esterilizado', ''),
...
INSERT INTO public.categorias_servicios 
...
INSERT INTO public.servicios_procedimientos 
...
INSERT INTO public.tipos_pruebas 
...
INSERT INTO public.pruebas_laboratorio 
...
('Vacuna Antirrábica', 'Letargo leve, dolor en el sitio de inyección', 'Rabia', '1 mL','2 mL','1.5 mL', 'LOT-RAB-2025', '2026-12-31', CURRENT_DATE, 365, DEFAULT, 40000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
('Vacuna Moquillo Canino', 'Fiebre leve, pérdida de apetito temporal', 'Moquillo', '1 mL','2 mL','1.5 mL', 'LOT-MOQ-2025', '2026-06-15', CURRENT_DATE, 1095, DEFAULT, 35000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
('Vacuna Parvovirus', 'Hinchazón en el sitio de inyección', 'Parvovirosis', '1 mL','2 mL','1.5 mL', 'LOT-PAR-2025', '2026-08-20', CURRENT_DATE, 365, DEFAULT, 35000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
('Vacuna Leptospirosis', 'Dolor local, fiebre baja', 'Leptospirosis', '1 mL','2 mL','1.5 mL', 'LOT-LEP-2025', '2026-05-30', CURRENT_DATE, 365, DEFAULT, 35000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
-- Vacunas para gatos
('Vacuna Triple Felina', 'Somnolencia leve', 'Panleucopenia/Calicivirus/Rinotraqueitis', '1 mL','2 mL','1.5 mL', 'LOT-TRF-2025', '2026-09-10', CURRENT_DATE, 365, DEFAULT, 38000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
('Vacuna Leucemia Felina', 'Malestar general', 'Leucemia Viral Felina', '1 mL','2 mL','1.5 mL', 'LOT-LEU-2025', '2026-11-25', CURRENT_DATE, 365, DEFAULT, 38000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
-- Vacunas especiales
('Vacuna Bordetella', 'Estornudos leves', 'Tos de las perreras', '0.5 mL','1 mL','0.7 mL', 'LOT-BOR-2025', '2026-04-15', CURRENT_DATE, 365, DEFAULT, 32000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
('Vacuna Coronavirus Canino', 'Malestar gastrointestinal leve', 'Coronavirus', '1 mL','2 mL','1.5 mL', 'LOT-COR-2025', '2026-07-22', CURRENT_DATE, 365, DEFAULT, 32000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
('Vacuna Giardia', 'Diarrea leve', 'Giardiasis', '1 mL','2 mL','1.5 mL', 'LOT-GIA-2025', '2026-10-05', CURRENT_DATE, 180, DEFAULT, 32000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
-- Vacunas combinadas
('Vacuna Polivalente V8', 'Fiebre leve, dolor local', 'Combinada Canina', '1 mL','2 mL','1.5 mL', 'LOT-V8-2025', '2026-03-18', CURRENT_DATE, 365, DEFAULT, 42000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
('Vacuna Felina V4', 'Decaimiento temporal', 'Combinada Felina', '1 mL','2 mL','1.5 mL', 'LOT-V4-2025', '2026-02-28', CURRENT_DATE, 365, DEFAULT, 42000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC')),
('Vacuna Influenza Canina', 'Tos leve', 'Influenza', '1 mL','2 mL','1.5 mL', 'LOT-INF-2025', '2026-01-15', CURRENT_DATE, 365, DEFAULT, 32000, TRUE, (SELECT id_pro FROM public.procedimientos WHERE nom_pro LIKE 'Vacunación SC'));

INSERT INTO public.vacunacion ( id_vacn, id_cit_vacn ) VALUES 
(1,2),
(1,3),
(7,3),
(7,9),
...
(10,24);
-- Motivos de consulta
INSERT INTO public.motivos_consultas (mot_con) VALUES
...
INSERT INTO public.tratamientos_consultas (nom_tra_con, des_tra_con) VALUES
