            ...
            <article className="help-window">
                ...
                {activeTab === 'contact' && (
                    ...
                    <div className="contact-card">
                        ...
                        <p>Email: <a href="mailto:soporte@clinivets.com">soporte@clinivets.com</a></p>
                    ...
                    <div className="contact-card">
                        ...
                        <p>Email: <a href="mailto:admin@clinivets.com">admin@clinivets.com</a></p>
                        <p>Teléfono: <a href="tel:+123456788">+1 234 567 88</a></p>
                ...
                {activeTab === 'faq' && (
                    ...
                    <div className="faq-item">
                        ...
                        <p>Sí, en la sección "Mis Citas" puedes ver tus citas programadas y cancelarlas con al menos 24 horas de anticipación.</p>
                    </div>
