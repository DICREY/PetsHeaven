...
// Main component
export const FormularioRegMascota = ({ onRegist, URL = "" }) => {
  // Estados
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const { data: uploadData, error: uploadError } = await supabase.storage.from("mascotas").upload(fileName, imagen)
      ...
      const {
        data: { publicUrl },
      } = supabase.storage.from("mascotas").getPublicUrl(uploadData.path)
  ...
  return (
    <main className="bg-gray-50 min-h-screen p-6">
      <section className="formContMascota mx-auto">
        <article className="formCardMascota bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="supContBotonesMascota">
            ...
            <div className="botonesMascota">
              <button type="button" className="btn-container secundary" onClick={() => window.history.back()}>
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
            ...
            <fieldset className="contPasoMascota">
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="nombre">
                  Nombre de la mascota <span className="obligatorio-m">*</span>
                </label>
                <input
                  id="nombre"
                  name="nombre"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="especie">
                  Especie <span className="obligatorio-m">*</span>
                </label>
                <select
                  id="especie"
                  name="especie"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="raza">
                  Raza de la mascota <span className="obligatorio-m">*</span>
                </label>
                <input
                  id="raza"
                  name="raza"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="color">
                  Color de la mascota <span className="obligatorio-m">*</span>
                </label>
                <input
                  id="color"
                  name="color"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="alimento">
                  Alimento preferido <span className="obligatorio-m">*</span>
                </label>
                <input
                  id="alimento"
                  name="alimento"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="edad">
                  Fecha de nacimiento <span className="obligatorio-m">*</span>
                </label>
                <input
                  id="edad"
                  name="edad"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="peso">
                  Peso de la mascota (kg) <span className="obligatorio-m">*</span>
                </label>
                <input
                  id="peso"
                  name="peso"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="sexo">
                  Sexo de la mascota <span className="obligatorio-m">*</span>
                </label>
                <select
                  id="sexo"
                  name="sexo"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="est_rep">
                  Estado Reproductivo de la mascota <span className="obligatorio-m">*</span>
                </label>
                <select
                  id="est_rep"
                  name="est_rep"
              ...
              <div className="grupoCampoMascota">
                <label htmlFor="propietario">
                  Propietario<span className="obligatorio-m">*</span>
                </label>
                <input
                  id="propietario"
                  name="propietario"
                  ...
                  className={errors.propietario ? "campoErrorMascota campo-error-m" : ""}
                  {...register("propietario", {
                    required: "Este campo es obligatorio",
                  })}
                />
                {errors.propietario && <p className="msjErrorMascota mensaje-error-m">{errors.propietario.message}</p>}
              </div>
            </fieldset>
          </form>
        </article>
